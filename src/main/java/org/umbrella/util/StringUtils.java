...
public class StringUtils {
    ...
    /**
     * Retrieve a consistently reproducible package unique identifier. It uses both
     * <b>gav</b> and <b>packageName</b>
     *
     * @param gav
     * @param packageName
     * @return
    ...
    private static List<String> codeAwareSplitOnChar(CharSequence string, boolean useAngularParenthesis,
            boolean trimArgs, char... chs) {
            ...
            if (contains(chs, string.charAt(i))) {
                ...
                switch (string.charAt(i)) {
                    ...
                    case '{':
                        ...
                        break;
                    case '<':
                        if (useAngularParenthesis && !isSingleQuoted && !isDoubleQuoted)
                            nestedParam++;
                        break;
                    case ')':
                    case ']':
     ...
     * whitespace between double-quotes
     * The two inputs MUST BE valid DRL/Java syntax (this validation is NOT
     * performed by this method, this method assumes they are).
     * Null check: if either of the input is null, this method will return true IFF
     * both are null.
     * Empty check: if either of the input is an empty string, it will be considered
     * as a whitespace during code-aware comparison.
     */
