package org.umbrella.base.reteoo.builder;
...
public interface ReteooComponentBuilder {
     ...
     * 
     * In other words, if it returns true and no previous TupleSource is already
     * created,
     * an InitialFact pattern must be added with appropriate left input adapter for
     * the network to be correctly built.
     * 
     * For instance, NOT / EXISTS / ACCUMULATE are examples of builders that must
     * return true
