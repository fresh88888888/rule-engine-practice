...
import org.umbrella.kie.api.conf.KieBaseOptionsConfiguration;

/**
 * <p>
 * A class to store KieBase related configuration. It must be used at KieBase
 * instantiation time
 * or not used at all.
 * </p>
 *
 ...
 *
 * <p>
 * So if you want to set a default configuration value for all your new KieBase,
 * you can simply set the property as
 * a System property.
 * </p>
 *
 * <p>
 * After the KieBase is created, it makes the configuration immutable and there
