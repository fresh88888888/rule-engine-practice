...
import org.umbrella.kie.api.event.kiescanner.KieScannerEventListener;

/**
 * A KieScanner is a scanner of the maven repositories (both local and remote)
 * used to automatically discover if there are new releases for a given
 * KieModule and its dependencies
