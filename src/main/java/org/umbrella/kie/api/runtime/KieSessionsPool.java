...
public interface KieSessionsPool {
    /**
     * Obtain a {@link KieSession} from this pool using the default session
     * configuration.
    ...
    /**
     * Obtain a {@link KieSession} from this pool using using the given session
     * configuration.
     * Calling {@link KieSession#dispose()} on this session when you are done will
     * push it back into the pool.
     *
    ...
    /**
     * Obtain a {@link StatelessKieSession} from this pool using the default session
     * configuration.
    ...
    /**
     * Obtain a {@link StatelessKieSession} from this pool using using the given
