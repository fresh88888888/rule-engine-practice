...
/**
 * <p>
 * A channel provides a mechanism to send objects from the working memory to
 * some external process
 * or function. For instance, a channel can be used to inform some piece of code
 * that an object
 * matches a rule.
 * </p>
 *
 * <p>
 * To create a channel, implement the interface and register it with the
 * KieRuntime:
 * </p>
 * 
 * <pre>
