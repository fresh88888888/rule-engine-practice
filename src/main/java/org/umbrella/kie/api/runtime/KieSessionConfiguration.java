...
import org.umbrella.kie.api.runtime.conf.KieSessionOptionsConfiguration;
 ...
 *
 * So if you want to set a default configuration value for all your new
 * KieSession, you can simply set the property as
 * a System property.
 *
 * After the KieSession is created, it makes the configuration immutable and
 * there is no way to make it
 * mutable again. This is to avoid inconsistent behaviour inside KieSession.
 */
public interface KieSessionConfiguration extends KieSessionOptionsConfiguration{
