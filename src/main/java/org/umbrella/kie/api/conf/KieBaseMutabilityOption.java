 ...
 * By default mutability (incremental compilation) is allowed but for
 * performances reasonds
 * it is strongly recommended to set this option to "disabled" if you don't need
 * it.
 *
