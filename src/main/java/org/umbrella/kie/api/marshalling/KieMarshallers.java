 ...
 *
 * <p>
 * This api is experimental and thus the classes and the interfaces returned are
 * subject to change.
 * </p>
 */
public interface KieMarshallers extends KieService{
    ...
    /**
     * The marshalling strategies for this method are undefined and thus they are
     * derived from the ksession's or environment
     * provided.
     *
     * @param kbase
     ...
     * @param kbase
     * @param strategies
     * @return marshaller created for the specified KieBase with the custom
     *         marshalling strategies
     */
    Marshaller newMarshaller(KieBase kBase, ObjectMarshallingStrategy[] strategys);
